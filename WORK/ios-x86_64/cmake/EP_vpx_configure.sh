...
export PATH="$PATH:/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/WORK/ios-x86_64/cmake/programs"
export PKG_CONFIG="/usr/local/bin/pkg-config"
export PKG_CONFIG_PATH=""
export PKG_CONFIG_LIBDIR="/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/liblinphone-sdk/x86_64-apple-darwin.ios/lib/pkgconfig"

cd "/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/WORK/ios-x86_64/Build/vpx"

if [ ! -f "vpx_config.h" ]
then
	 
	CC=$CC_NO_LAUNCHER LD=$CC_NO_LAUNCHER ASFLAGS=$ASFLAGS CFLAGS=$CFLAGS LDFLAGS=$LDFLAGS "/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/submodules/externals/libvpx/configure"  "--prefix=/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/liblinphone-sdk/x86_64-apple-darwin.ios" "--target=x86_64-iphonesimulator-gcc" "--prefix=/Users/vijaychaudhry/Desktop/SVN/Test/linphone-iphone/liblinphone-sdk/x86_64-apple-darwin.ios" "--target=x86_64-iphonesimulator-gcc" "--enable-static" "--disable-shared" "--enable-error-concealment" "--enable-multithread" "--enable-realtime-only" "--enable-spatial-resampling" "--enable-vp8" "--disable-vp9" "--enable-libs" "--disable-install-docs" "--disable-debug-libs" "--disable-examples" "--disable-unit-tests" "--as=yasm" 
fi
