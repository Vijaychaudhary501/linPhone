...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([specifier.type isEqualToString:kIASKPSToggleSwitchSpecifier]) {
        ...
        if ([specifier.key  isEqual: @"primary_displayname_preference"]){
            
        }
        else if ([specifier.key  isEqual: @"primary_displayname_preference"]){
        ...
        if ([specifier.key  isEqual: @"primary_displayname_preference"]){
            textField.text = @"Executel iPhone";
        }
        else if ([specifier.key  isEqual: @"primary_username_preference"]){
            textField.text = @"Executel.iPhone";
        }
        else{
