...
- (void)viewWillAppear:(BOOL)animated {
    ...
    _transportsegment.selectedSegmentIndex = 1;
...
- (void)changeView:(UIView *)view back:(BOOL)back animation:(BOOL)animation {
	...
	if (view == _welcomeView) {
		...
		if (!placement_done) {
            ...
            _gotoCreateAccountButton.hidden = YES;//!show_new;
...
- (void)reader:(QRCodeReaderViewController *)reader didScanResult:(NSString *)result
{
   ...
   /* [self dismissViewControllerAnimated:YES completion:^{
    ...
    NSDictionary *dic = [XMLReader dictionaryForXMLString:result error:nil];
    ...
    for (UIView *view in @[
        ...
        UIAssistantTextField *atf =
        (UIAssistantTextField *)[self findView:ViewElement_Domain inView:view ofType:UIAssistantTextField.class];
        NSLog(@"Register server %@",dic[@"AccountConfig"][@"Account"][@"RegisterServer"][@"text"]);
        NSString *serverName = dic[@"AccountConfig"][@"Account"][@"RegisterServer"][@"text"];
        atf.text = [serverName stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        
        atf =
        (UIAssistantTextField *)[self findView:ViewElement_Password inView:view ofType:UIAssistantTextField.class];
        serverName = dic[@"AccountConfig"][@"Account"][@"AuthPass"][@"text"];
        atf.text = [serverName stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        
        atf =
        (UIAssistantTextField *)[self findView:ViewElement_DisplayName inView:view ofType:UIAssistantTextField.class];
        
        serverName = dic[@"AccountConfig"][@"Account"][@"DisplayName"][@"text"];
        atf.text = [serverName stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        ...
        serverName = dic[@"AccountConfig"][@"Account"][@"AuthID"][@"text"];
        atf.text = [serverName stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    }
        
    
    
   // [[self findTextField:ViewElement_Domain] setText:dic[@"AccountConfig"][@"Account"][@"RegisterServer"][@"text"]];
   // [self findTextField:ViewElement_Domain].text = dic[@"AccountConfig"][@"Account"][@"RegisterServer"][@"text"];
    [self findTextField:ViewElement_Password].text = dic[@"AccountConfig"][@"Account"][@"AuthPass"][@"text"];
    [self findTextField:ViewElement_DisplayName].text = dic[@"AccountConfig"][@"Account"][@"DisplayName"][@"text"];
    [self findTextField:ViewElement_Username].text = dic[@"AccountConfig"][@"Account"][@"AuthID"][@"text"];
    [self onGotoLoginClick:_gotoLoginButton];
    [self onLoginClick:_gotoLinphoneLoginButton];
